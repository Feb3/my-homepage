  ...
  try {
    ...
    const aiRes = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: "user",
          content: `아래 뉴스 목록에서 LH 주도의 공공재개발 사업 관련 뉴스만 골라줘. 조건: 1) 수도권(서울/경기/인천) 공공재개발이거나, 2) LH/국토교통부의 전국 공공재개발 정책이어야 함. 제외 조건: 노후계획도시, 민간재개발, 대전/부산/대구/광주/울산 단독 지방 뉴스. 해당하는 번호만 쉼표로 구분해서 답해줘. 예: 1,3,5\n\n${titles}`
        }]
      }),
    });
